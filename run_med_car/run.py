...
def main():
    ...
    try:
        try:
            ...
            shm = shared_memory.SharedMemory(name=shm_name, create=True, size=640*480*3)
        shm.close()
        p_track = Process(target=track_main, args=(shm_name, frame_ready, None, pipe2, stop_event, 0))
        p_detect = Process(target=detect_main, args=(shm_name, frame_ready, pipe2, stop_event, 1))
